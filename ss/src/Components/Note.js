                                        ...
                                        <div className='note'>
                                            <span className='spn'>{item.text}</span>
                                                  <div className='note-footer'>
                                                    ...
                                                    <button id="read" onClick={props.delNoteInfo.bind(this, item.id)}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
